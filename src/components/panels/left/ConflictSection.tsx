  ...
  return (
    <div>
      ...
      >
        ...
        <span className="neo-kicker flex-1 text-left text-domain-conflict">Conflicts</span>
      ...
      {expanded && (
        <div className="border-b border-line-muted bg-background">
          {CONFLICT_EVENT_TYPES.map(type => {
            ...
            const dotColor = 'var(--domain-conflict)'
            ...
            return (
              <div key={type}>
                <div className="flex items-center border-b border-line-muted">
                  ...
                  >
                    <span className="inline-block size-2 flex-shrink-0 border border-domain-conflict" style={{ backgroundColor: isOn ? dotColor : 'transparent' }} />
                  ...
                  <TypeToggle on={isOn} color={dotColor} label={CONFLICT_EVENT_LABELS[type]} onClick={() => toggleType(type)} />
                </div>
                        ...
                        >
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-1.5 mt-0.5">
                              ...
                              {event.fatalities > 0 && (
                                <span className="font-mono text-[10px] text-danger">{event.fatalities} fatal</span>
                              )}
                            </div>
                          </div>
