...
export function TopBar({ activeView, onViewChange, sessionStart }: TopBarProps) {
    ...
    <header className="fixed top-0 left-0 right-0 h-[46px] bg-zinc-900 border-b border-zinc-800 flex items-center pl-4 z-50">
      ...
      <div className="flex items-center gap-2.5 pr-5 border-r border-zinc-800 h-full flex-shrink-0">
        ...
        <div>
          ...
          <div className="text-[9px] text-zinc-600 tracking-[2px] uppercase mt-px">Geospatial Intelligence</div>
        </div>
      </div>
      ...
      <div className="flex items-center ml-auto h-full">
        <div className="flex items-center gap-2 px-4 h-full border-l border-zinc-800 font-mono text-[10px] text-zinc-600">
          <Pip color="ok" /> Feeds Live
        </div>
        <div className="flex items-center gap-2 px-4 h-full border-l border-zinc-800 font-mono text-[10px] text-zinc-600">
          <Pip color="warn" /> 3 Alerts
        </div>
        <div className="flex items-center gap-2 px-4 h-full border-l border-zinc-800 font-mono text-[10px] text-zinc-600">
          <Pip color="ok" /> Uplink
        </div>
        <div className="flex flex-col justify-center items-end px-4 h-full border-l border-zinc-800 min-w-[104px]">
          ...
          <span className="font-mono text-[9px] text-zinc-600 tracking-wide mt-px">{date}</span>
        </div>
      </div>
    </header>
  )
